...
# Returns fake user agents
class ScrapeOpsFakeUserAgentsMiddleware:

    @classmethod
    def from_crawler(cls, crawler):
        return cls(crawler.settings)

    # initialising the required settings to get the fake user agents list
    ...
    # Requests are made to get the fake user agents
    ...
    # Gets random user agent from the fake user agent list
    ...
    # Scrapy function that scrapy will look for when using the middleware
    def process_request(self, request, spider):
